...
values
    ...
    ('PROMOTION_SPY_PIONEER',     'LOC_PROMOTION_SPY_PIONEER_NAME',    'LOC_PROMOTION_SPY_PIONEER_DESCRIPTION',     'PROMOTION_CLASS_SPY', 1,  NULL),
...
--------------------------------------------------------------------------------------------------------------
--SPY-间谍向导相关的的范围加速代码，先驱相关的范围无视地形地貌代码，观察者的视野代码

...
values
    ...
    ("zh_Hans_CN",  "LOC_GAMEMODE_MILITARY_DESCRIPTION",                    "未完成的模式，当前模式中新增了8个陆地作战单位和2个陆地支援单位。[NEWLINE][NEWLINE]劫掠消耗移动力改为2； [NEWLINE]击杀主要文明和城邦单位时获得等同于被击杀单位战斗力25%的大军点/提督点；[NEWLINE]攻占城市后获得等同于剩余人口数*30的金币，建造军阀宝座后翻倍; [NEWLINE]允许打蛮子升到3级（3级以后最多获得1经验，本体是2级）"),
    ...
    ("zh_Hans_CN",  "LOC_GAMEMODE_AITEST_DESCRIPTION",                      "[COLOR_Red]未完成的模式，请勿开启[ENDCOLOR]。用于测试的模式，当前测试模式中调整了AI。"),
    ...
    ("zh_Hans_CN",  "LOC_MAP_WET_LAKES_DESCRIPTION",                        "遍布湿地和海滨的广袤陆地，森林和沼泽组成独特的生态景观。"),
